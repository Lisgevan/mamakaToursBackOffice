	...
	return (
		<form action={formAction} className="space-y-4 bg-gray-400 p-4 flex flex-col gap-2 w-3/5 m-auto text-gray-900">
			...
			<div className="flex justify-around ">
				<Select name="transferType">Transfer Type: </Select>
				<Select name="agent">Transfer Agent: </Select>
			</div>

			{/* Transfer Mean and name */}
			<div className="flex justify-around">
				<Select name="transferMean" onChange={handleSelectChange}>
					Transfer Mean:{" "}
				</Select>
				<div>
			...
			{/* location from / to */}
			<div className="flex justify-around ">
				<Select name="locationFrom">Location From: </Select>
				<Select name="locationTo">Location To: </Select>
			</div>
